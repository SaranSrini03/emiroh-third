      ...
      <div className="mx-auto max-w-xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        ...
        <div className="mt-4 flex justify-center">
          <div className="relative w-64 rounded-full bg-gray-200 p-1">
            <span
              className={`absolute inset-y-1 left-1 w-[calc(50%-0.25rem)] rounded-full bg-[#2f4a8a] transition-transform duration-200 ${
                role === "influencer" ? "translate-x-full" : "translate-x-0"
              }`}
              aria-hidden="true"
            />
            <button
              ...
              className={`relative z-10 w-1/2 rounded-full px-4 py-1.5 text-sm font-medium transition-colors ${
                role === "brand" ? "text-white" : "text-gray-700"
              }`}
            ...
            <button
              ...
              className={`relative z-10 w-1/2 rounded-full px-4 py-1.5 text-sm font-medium transition-colors ${
                role === "influencer" ? "text-white" : "text-gray-700"
              }`}
