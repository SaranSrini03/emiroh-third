...
import MatchBanner from "@/components/misc/MatchBanner";
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="p-6">
        ...
        <MatchBanner
          name="Natal Craig"
          matchPercent="82%"
          description="Strong male audience in Mumbai (65%), high engagement in Men’s Fashion niche."
          onView={() => alert("Viewing details for Natal Craig")}
        />
